...
SUB,VAR1,VAR2: SUBtract VAR1 from VAR2 into VAR1
...
ILT,VAR1,INT: If VAR1 Less Than INT then do all until CEQ
IGT,VAR1,INT: If VAR1 Greater Than INT then do all until CEQ
